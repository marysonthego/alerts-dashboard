            ...
            <>
              <div className="d-flex align-items-center p-8 rounded-top">
                <div className="symbol symbol-md bg-light-primary mr-3 flex-shrink-0">
                  <img
                    src={toAbsoluteUrl('/media/a4g/avatars/023-girl-13.jpg')}
                    alt=""
                  />
                </div>
          ...
          {!layoutProps.light && (
            <div
              ...
              <div className="symbol bg-white-o-15 mr-3">
                <span className="symbol-label text-success font-weight-bold font-size-h4"></span>
                <img
                  src={toAbsoluteUrl('/media/a4g/avatars/023-girl-13.jpg')}
                  alt=""
                />
              </div>
              <div className="text-white m-0 flex-grow-1 mr-3 font-size-h5"></div>
