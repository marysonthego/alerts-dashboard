                ...
                <span className="navi-link p-0 pb-2">
                  <span className="navi-icon mr-1">
                    <span className="svg-icon-lg svg-icon-primary">
                      <SVG
                        src="media/svg/icons/Communication/Mail-notification.svg"></SVG>
                    </span>
                  </span>
              ...
              <div className="symbol symbol-40 bg-light mr-3">
                <div className="symbol-label">
                  <span className="svg-icon svg-icon-md svg-icon-danger">
                    <SVG
                      src="/media/svg/icons/Files/Selected-file.svg"></SVG>
                  </span>
                </div>
              </div>
              <div className="navi-text">
              ...
              <div className="symbol symbol-40 bg-light mr-3">
                <div className="symbol-label">
                  <span className="svg-icon svg-icon-md svg-icon-primary">
                    <SVG
                      src="/media/svg/icons/Communication/Mail-opened.svg"></SVG>
                  </span>
                </div>
              </div>
              <div className="navi-text">
        ...
        <div>
          ...
          <div className="d-flex align-items-center bg-light-info rounded p-5">
            <span className="svg-icon svg-icon-info mr-5">
              <SVG
                src="/media/svg/icons/General/Attachment2.svg"
                className="svg-icon svg-icon-lg"
              ></SVG>
            </span>
